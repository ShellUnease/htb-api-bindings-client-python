...
T = TypeVar("T", bound="GetV4MachineProfileIdResponse200InfoMaker")


@_attrs_define
class GetV4MachineProfileIdResponse200InfoMaker:
    """
    Attributes:
        id (float | Unset):
        name (str | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v4_machine_profile_id_response_200_info_maker = cls(
            id=id,
            name=name,
            avatar=avatar,
        ...
        get_v4_machine_profile_id_response_200_info_maker.additional_properties = d
        return get_v4_machine_profile_id_response_200_info_maker
