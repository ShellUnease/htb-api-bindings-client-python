...
T = TypeVar("T", bound="GetV4MachineRecommendedResponse200Card2FeedbackForChart")


@_attrs_define
class GetV4MachineRecommendedResponse200Card2FeedbackForChart:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v4_machine_recommended_response_200_card_2_feedback_for_chart = cls(
        ...
        get_v4_machine_recommended_response_200_card_2_feedback_for_chart.additional_properties = d
        return get_v4_machine_recommended_response_200_card_2_feedback_for_chart
