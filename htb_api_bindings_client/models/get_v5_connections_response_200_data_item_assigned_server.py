...
T = TypeVar("T", bound="GetV5ConnectionsResponse200DataItemAssignedServer")


@_attrs_define
class GetV5ConnectionsResponse200DataItemAssignedServer:
    """
    Attributes:
        id (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v5_connections_response_200_data_item_assigned_server = cls(
            id=id,
        ...
        get_v5_connections_response_200_data_item_assigned_server.additional_properties = d
        return get_v5_connections_response_200_data_item_assigned_server
