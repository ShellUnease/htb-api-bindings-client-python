...
T = TypeVar("T", bound="PostV4ContainerStopBody")


@_attrs_define
class PostV4ContainerStopBody:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        post_v4_container_stop_body = cls(
            containerable_id=containerable_id,
        )

        post_v4_container_stop_body.additional_properties = d
        return post_v4_container_stop_body
