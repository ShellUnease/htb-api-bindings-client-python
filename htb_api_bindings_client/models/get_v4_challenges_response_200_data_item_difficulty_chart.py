...
T = TypeVar("T", bound="GetV4ChallengesResponse200DataItemDifficultyChart")


@_attrs_define
class GetV4ChallengesResponse200DataItemDifficultyChart:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v4_challenges_response_200_data_item_difficulty_chart = cls(
        ...
        get_v4_challenges_response_200_data_item_difficulty_chart.additional_properties = d
        return get_v4_challenges_response_200_data_item_difficulty_chart
