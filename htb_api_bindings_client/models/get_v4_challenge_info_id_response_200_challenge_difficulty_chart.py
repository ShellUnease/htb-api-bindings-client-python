...
T = TypeVar("T", bound="GetV4ChallengeInfoIdResponse200ChallengeDifficultyChart")


@_attrs_define
class GetV4ChallengeInfoIdResponse200ChallengeDifficultyChart:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v4_challenge_info_id_response_200_challenge_difficulty_chart = cls(
        ...
        get_v4_challenge_info_id_response_200_challenge_difficulty_chart.additional_properties = d
        return get_v4_challenge_info_id_response_200_challenge_difficulty_chart
