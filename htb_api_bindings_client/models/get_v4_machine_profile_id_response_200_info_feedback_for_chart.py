...
T = TypeVar("T", bound="GetV4MachineProfileIdResponse200InfoFeedbackForChart")


@_attrs_define
class GetV4MachineProfileIdResponse200InfoFeedbackForChart:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v4_machine_profile_id_response_200_info_feedback_for_chart = cls(
        ...
        get_v4_machine_profile_id_response_200_info_feedback_for_chart.additional_properties = d
        return get_v4_machine_profile_id_response_200_info_feedback_for_chart
