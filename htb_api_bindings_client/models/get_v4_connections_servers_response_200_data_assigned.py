...
T = TypeVar("T", bound="GetV4ConnectionsServersResponse200DataAssigned")


@_attrs_define
class GetV4ConnectionsServersResponse200DataAssigned:
    """
    Attributes:
        id (float | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_v4_connections_servers_response_200_data_assigned = cls(
            id=id,
        ...
        get_v4_connections_servers_response_200_data_assigned.additional_properties = d
        return get_v4_connections_servers_response_200_data_assigned
